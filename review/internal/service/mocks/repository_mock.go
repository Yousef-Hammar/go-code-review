...
func (_m *MockRepository) FindByCode(_a0 string) (*domain.Coupon, error) {
	ret := _m.Called(_a0)
...
func (_c *MockRepository_FindByCode_Call) Return(_a0 *domain.Coupon, _a1 error) *MockRepository_FindByCode_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepository_FindByCode_Call) RunAndReturn(run func(string) (*domain.Coupon, error)) *MockRepository_FindByCode_Call {
	_c.Call.Return(run)
	return _c
}

// Save provides a mock function with given fields: _a0
func (_m *MockRepository) Save(_a0 domain.Coupon) error {
	ret := _m.Called(_a0)
...
func (_c *MockRepository_Save_Call) Run(run func(_a0 domain.Coupon)) *MockRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRepository_Save_Call) RunAndReturn(run func(domain.Coupon) error) *MockRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
